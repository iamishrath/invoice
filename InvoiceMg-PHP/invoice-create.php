			...
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					...
					<div class="input-group col-xs-4 float-right">
						...
						<input type="text" name="invoice_id" id="invoice_id" class="form-control required" placeholder="Invoice Number" aria-describedby="sizing-addon1" value="<?php echo getInvoiceId(); ?>">
					</div>
				</div>
			</div>
			<div class="row">
